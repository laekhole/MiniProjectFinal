...
//import com.kosa.project_final.board.service.BoardService3;
...
//
//    	try { 
////    		boardService.getBoardList2(board)
//    		
//    		List<BoardDTO> boardList = boardService.getBoardList(); // 기존 리스트 가져오기
//
//    	    for (BoardDTO boardDTO : boardList) {
//    	        int level = boardDTO.getLevel(); // 레벨 가져오기
//    	        StringBuilder indentation = new StringBuilder();
//    	        for (int i = 0; i < level; i++) {
//    	            indentation.append(" ");
//    	        }
//    	        boardDTO.setTitle(indentation.toString() + "[답글]" + boardDTO.getTitle());
//    	    }
